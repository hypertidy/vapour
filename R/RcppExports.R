...
gh_GDALWarp <- function(dsn, sds, dimension, extent, projection) {
    .Call('_vapour_gh_GDALWarp', PACKAGE = 'vapour', dsn, sds, dimension, extent, projection)
}
...
gh_GDALGetDescription <- function(xp) {
    .Call('_vapour_gh_GDALGetDescription', PACKAGE = 'vapour', xp)
}

gh_GDALGetGeoTransform <- function(xp) {
    .Call('_vapour_gh_GDALGetGeoTransform', PACKAGE = 'vapour', xp)
}

gh_GDALGetFileList <- function(xp) {
    .Call('_vapour_gh_GDALGetFileList', PACKAGE = 'vapour', xp)
}

gh_GDALGetRasterSize <- function(xp) {
    .Call('_vapour_gh_GDALGetRasterSize', PACKAGE = 'vapour', xp)
}

gh_GDALClose <- function(xp) {
    .Call('_vapour_gh_GDALClose', PACKAGE = 'vapour', xp)
}

gh_ExecuteSQL <- function(xp, sql, extent) {
    .Call('_vapour_gh_ExecuteSQL', PACKAGE = 'vapour', xp, sql, extent)
}

gh_GetLayer <- function(xp, layer) {
    .Call('_vapour_gh_GetLayer', PACKAGE = 'vapour', xp, layer)
}

gh_GetNextFeature <- function(xp) {
    .Call('_vapour_gh_GetNextFeature', PACKAGE = 'vapour', xp)
}

gh_DestroyFeature <- function(xp) {
    .Call('_vapour_gh_DestroyFeature', PACKAGE = 'vapour', xp)
}

gh_getGeometryRef <- function(xp) {
    .Call('_vapour_gh_getGeometryRef', PACKAGE = 'vapour', xp)
}

gh_getPoints_preview <- function(xp) {
    .Call('_vapour_gh_getPoints_preview', PACKAGE = 'vapour', xp)
}

gh_exportToWkb <- function(xp) {
    .Call('_vapour_gh_exportToWkb', PACKAGE = 'vapour', xp)
}

gh_GetGDALDriverManager <- function() {
    .Call('_vapour_gh_GetGDALDriverManager', PACKAGE = 'vapour')
}

gh_GetDriverCount <- function(xp) {
    .Call('_vapour_gh_GetDriverCount', PACKAGE = 'vapour', xp)
}

gdalmdimarray_cpp <- function(dsn, array) {
    .Call('_vapour_gdalmdimarray_cpp', PACKAGE = 'vapour', dsn, array)
}
