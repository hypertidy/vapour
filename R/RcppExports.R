...
gdal_geom_has <- function(dsn, layer, sql, ex) {
    .Call('_vapour_gdal_geom_has', PACKAGE = 'vapour', dsn, layer, sql, ex)
}
...
warp_in_memory_gdal_cpp <- function(dsn, source_WKT, target_WKT, target_geotransform, target_dim, band) {
    .Call('_vapour_warp_in_memory_gdal_cpp', PACKAGE = 'vapour', dsn, source_WKT, target_WKT, target_geotransform, target_dim, band)
}
