...
dsn_read_transform_geom_ij <- function(dsn, layer, sql, ex, format, ij, crs) {
    .Call('_vapour_dsn_read_transform_geom_ij', PACKAGE = 'vapour', dsn, layer, sql, ex, format, ij, crs)
}
