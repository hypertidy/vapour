...
gdal_set_config_option <- function(option, value) {
    .Call('_vapour_gdal_set_config_option', PACKAGE = 'vapour', option, value)
}

gdal_get_config_option <- function(option) {
    .Call('_vapour_gdal_get_config_option', PACKAGE = 'vapour', option)
}
