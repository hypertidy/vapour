...
#'  \code{\link{vapour_sds_names}}          \tab list individual raster sources in a source containing subdatasets
#' }
#'
#' \tabular{ll}{
...
#'  \code{\link{vapour_read_geometry_text}} \tab read geometry in text form, various formats
#' }
#'
