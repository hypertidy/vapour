...
We aim to provide access to the basic *read* functions available in [GDAL](http://www.gdal.org/), which provides an abstraction for geospatial data including a  [raster](http://www.gdal.org/gdal_datamodel.html) and a [vector](http://www.gdal.org/ogr_arch.html) data model. 
