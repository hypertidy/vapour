...
easier touse and share. Specifically `Rcpp` means that access to external libs
...
automatable build process for libraries on Windows. Mark Padgham helped kick me
