...
An example is [RGDALSQL](https://github.com/mdsumner/RGDALSQL) aiming to leverage the facilities of GDAL to provide data *on-demand* for many sources *as if* they were databases. 
