...
The vapour package provides access to the basic *read* functions available in [GDAL](https://www.gdal.org/) for both [raster](https://www.gdal.org/raster_datamodel.html) and [vector](https://gdal.org/tutorials/vector_api_tut.html) data sources. 
