...
// gh_GDALOpenEx
SEXP gh_GDALOpenEx(CharacterVector dsn, IntegerVector sds);
RcppExport SEXP _vapour_gh_GDALOpenEx(SEXP dsnSEXP, SEXP sdsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< CharacterVector >::type dsn(dsnSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type sds(sdsSEXP);
    rcpp_result_gen = Rcpp::wrap(gh_GDALOpenEx(dsn, sds));
    return rcpp_result_gen;
END_RCPP
}
// gh_GDALRasterIO
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_vapour_gh_GDALOpenEx", (DL_FUNC) &_vapour_gh_GDALOpenEx, 2},
